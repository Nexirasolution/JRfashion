...
async function main() {
  ...
  // 1. Admin account
  const email = (process.env.ADMIN_EMAIL || 'admin@jrfashion.com').toLowerCase();
  ...
  if (!existingSettings) {
    await Settings.create({
      key: 'global',
      storeName: 'JR Fashion',
      whatsapp: '918056114537',
      instagram: 'JR Fashion',
      address: 'Tirupur, Tamil Nadu',
      shippingFee: 49,
      freeShippingAbove: 999,
      seoTitle: 'JR Fashion',
      seoDescription: 'Shop trendy women kurtis from JR Fashion, Tirupur.'
    });
